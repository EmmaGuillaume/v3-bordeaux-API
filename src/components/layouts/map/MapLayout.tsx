...
import BikesOrPlacesButton from '@/components/buttons/bikesOrPlaces/BikesOrPlacesButton'
import FavoritesStationsButton from '@/components/buttons/favoritesStations/FavoritesStationsButton'
